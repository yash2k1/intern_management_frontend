        ...
        {isDropdownOpen && (
          <div className="fixed right-2 mt-2 w-56 rounded-lg shadow-lg z-50 text-sm">
            <MainButtons
              ...
              className={"w-full text-left px-4 py-2 cursor-pointer bg-secondary hover:bg-primary rounded-t-lg text-white"}
            />
            <MainButtons
              title={"Log Out"}
              onClick={handleSignOut}
              className={"w-full text-left px-4 py-2 cursor-pointer bg-secondary hover:bg-primary rounded-b-lg text-white"}
            />
          </div>
        )}
      </div>
